...
class ConfigManager:
    ...
    def _get_config_file_path(self) -> str:
        ...
        if sys.platform.startswith('win'):
            ...
            app_data_dir = os.path.join(os.path.expanduser('~'), 'Library', 'Application Support', 'Twilight Struggle Helper')
        else:
            # Linux: ~/.config/Twilight Struggle Helper/
            app_data_dir = os.path.join(os.path.expanduser('~'), '.config', 'Twilight Struggle Helper')
